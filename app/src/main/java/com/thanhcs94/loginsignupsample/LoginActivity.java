...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>{
    ...
    public static final int REQUEST_LOGIN_FB = 999999;
    public static final int REQUEST_LOGIN_GOOGLE = 999999;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgFbLogin.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult( new Intent(LoginActivity.this, DialogLoginFacebook.class), REQUEST_LOGIN_FB);
        ...
        imgPlusLogin.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult( new Intent(LoginActivity.this, DialogLoginGoogle.class), REQUEST_LOGIN_GOOGLE);
                overridePendingTransition(0, 0);
            }
        });
    }
